...
from llama_index.legacy.embeddings.huggingface_utils import DEFAULT_HUGGINGFACE_EMBEDDING_MODEL
from llama_index.legacy.embeddings.instructor import InstructorEmbedding
from llama_index.legacy.embeddings.langchain import LangchainEmbedding
from llama_index.legacy.embeddings.llm_rails import LLMRailsEmbedding, LLMRailsEmbeddings

...
from llama_index.legacy.indices.keyword_table.utils import extract_keywords_given_response
...
from llama_index.legacy.prompts.default_prompts import DEFAULT_QUERY_KEYWORD_EXTRACT_TEMPLATE

...
from llama_index.legacy.prompts.base import BasePromptTemplate, PromptTemplate, PromptType
from llama_index.legacy.prompts.mixin import PromptDictType, PromptMixinType
from llama_index.legacy.response_synthesizers import BaseSynthesizer, get_response_synthesizer

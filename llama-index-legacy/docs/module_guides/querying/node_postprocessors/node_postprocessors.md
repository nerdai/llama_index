...
```python
from llama_index.legacy.postprocessor import KeywordNodePostprocessor
...
```python
from llama_index.legacy.postprocessor import SentenceEmbeddingOptimizer
...
```python
from llama_index.legacy.indices import CohereRerank
...
```python
from llama_index.legacy.postprocessor import FixedRecencyPostprocessor
...
```python
from llama_index.legacy.postprocessor import EmbeddingRecencyPostprocessor
...
```python
from llama_index.legacy.postprocessor import TimeWeightedPostprocessor
...
```python
from llama_index.legacy.postprocessor import PIINodePostprocessor
...
```python
from llama_index.legacy.postprocessor import NERPIINodePostprocessor
...
```python
from llama_index.legacy.postprocessor import PrevNextNodePostprocessor
...
```python
from llama_index.legacy.postprocessor import AutoPrevNextNodePostprocessor

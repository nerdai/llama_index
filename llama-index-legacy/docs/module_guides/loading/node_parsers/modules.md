...
```python
from llama_index.legacy.node_parser.file import SimpleFileNodeParser
...
```python
from llama_index.legacy.node_parser import HTMLNodeParser
...
```python
from llama_index.legacy import JSONNodeParser
...
```python
from llama_index.legacy import MarkdownNodeParser
...
from llama_index.legacy.node_parser import LangchainNodeParser
...
```python
from llama_index.legacy.node_parser import HierarchicalNodeParser

...
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.multi_modal_llms.base.MultiModalLLM
   :members:
   :inherited-members:

Multi-Modal Embedding
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.embeddings.multi_modal_base.MultiModalEmbedding
   :members:
   :inherited-members:

Multi-Modal Vector Store Index
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.indices.multi_modal.base.MultiModalVectorStoreIndex
   :members:
   :inherited-members:

Multi-Modal Vector Index Retriever
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.indices.multi_modal.retriever.MultiModalVectorIndexRetriever
   :members:
   :inherited-members:

Multi-Modal Retriever Interface
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.core.base_multi_modal_retriever.MultiModalRetriever
   :members:
   :inherited-members:
...
^^^^^^^^^^^^^^^^^^^^^^^
.. autoclass:: llama_index.legacy.query_engine.multi_modal.SimpleMultiModalQueryEngine
   :members:
   :inherited-members:
